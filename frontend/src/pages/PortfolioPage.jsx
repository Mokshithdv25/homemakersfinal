...
export default function PortfolioPage() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans','Inter',sans-serif", background: "#fff", color: "#111", minHeight: "100vh" }}>

      {/* ══ HERO with overlay ══ */}
      <div style={{ position: "relative", minHeight: "62vh", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
        {/* Background image */}
        <div style={{
        ...
        <div style={{ position: "absolute", top: 20, right: 24, zIndex: 10 }}>
          <button
            ...
            style={{
              background: "#E05A20", color: "#fff", fontWeight: 700,
              fontSize: 15, padding: "11px 26px", borderRadius: 9,
              border: "none", cursor: "pointer",
              boxShadow: "0 4px 20px rgba(224,90,32,0.45)",
            }}
          >
            Work With Me
          </button>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 32px 28px" }}>
          <div style={{ display: "flex", alignItems: "flex-end", gap: 20, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 220 }}>
              ...
              <div style={{ color: "#FFB085", fontWeight: 700, fontSize: 15, marginTop: 3, marginBottom: 8 }}>Licensed {craftLabel}</div>
