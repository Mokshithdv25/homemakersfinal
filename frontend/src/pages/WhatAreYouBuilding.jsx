  ...
  return (
    <div className="relative min-h-screen bg-[#FBF7F2] overflow-x-hidden" style={{ fontFamily: "'DM Sans',Inter,system-ui,sans-serif", color: "#1C1917" }}>
      ...
      <button
        type="button"
        onClick={() => navigate("/")}
        className="absolute top-[5.5rem] left-4 md:left-8 flex items-center gap-2 border-none bg-transparent p-0 cursor-pointer text-sm text-[#5C5147] hover:text-[#C85F2B] transition-colors z-20"
      >
      ...
      {/* ── MAIN ── */}
      <main className="max-w-[920px] mx-auto px-5 md:px-8 pb-20 md:pb-24 pt-12 md:pt-16 relative z-10">
