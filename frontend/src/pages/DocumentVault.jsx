                        ...
                        <tr key={f.id} style={{ cursor: "pointer" }} onMouseEnter={(e) => (e.currentTarget.style.background = "#FAFAF8")} onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}>
                          ...
                          <td style={S.td}>
                            <div style={{ display: "flex", gap: 8 }}>
                              <button type="button" style={{ background: "none", border: "none", cursor: "pointer", color: "#7A6E62", fontSize: 16 }} title="Download" onClick={() => showToast(`Download requested: ${f.name}`)}>
                                ⬇
                              </button>
                              <button type="button" style={{ background: "none", border: "none", cursor: "pointer", color: "#9A8F87", fontSize: 16 }} title="More" onClick={() => showToast("More actions coming soon")}>
                                ⋮
                              </button>
                            </div>
                          </td>
