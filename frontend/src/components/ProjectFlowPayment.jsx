 ...
 * @param {() => void} p.onCompletePayment - checkout handoff while gateway activation is pending
 */
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, marginBottom: 10, flexWrap: "wrap" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "#78716C", marginTop: 2 }}>India · GST invoice issued when checkout is activated</div>
          </div>
        </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 16, flexWrap: "wrap" }}>
        ...
        {!paid && (
          <span style={{ fontSize: 11, color: "#9A8F87" }}>Online checkout is being activated; you will not be charged today.</span>
        )}
      </div>
    </div>
  );
